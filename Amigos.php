...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <img src="img/logo.png" class="d-inline-block align-top img-fluid" alt="Logo OpenFUX" id="imagenlogo">
          ...
          <form class="form-inline justify-content-center" id="barrabusqueda">
              <div class="input-group form-row">
                  <input type="text" class="form-control" aria-label="Recipient's username" aria-describedby="button-addon2" placeholder="Busca un amigo/a" id="buscador">
    ...
    <div class="container-fluid gedf-wrapper">
          <div class="row">
              <div class="col-md-3" id="luisdiaz">
                  <div class="card">
                      <div class="card-body">
                          <div class="mr-2">
                          <img class="rounded-circle" width="100" src="img/perfil.png" alt="Foto de perfil">
                          </div>
                          <div class="h5"><a href="Perfil.html" id="leecross">@LeeCross</a></div>
                      ...
                      <ul class="list-group list-group-flush">
                          ...
                          <li class="list-group-item">
                              <div class="h6 text-muted"><a href="#">Seguidos</a></div>
                              ...
                              <div class="text-center card-box">
                                  <div class="member-card pt-2 pb-2">
                                      ...
                                      <ul class="social-links list-inline">
                                          ...
                                          <li class="list-inline-item"><a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href="" data-original-title="Skype"><i class="fa fa-instagram"></i></a></li>
                                      </ul>
                                      <button type="button" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light">Enviar mensaje</button>
                                      <div class="mt-4 mr-4">
                                          <div class="row">
                                              <div class="col-4">
                                                  <div class="mt-3">
